...
# options passées :  helloC.c -mtune=generic -march=x86-64 -fverbose-asm
# options activées :  -fPIC -fPIE -faggressive-loop-optimizations
...
# helloC.c:16:    printf("Hello, World!\n");
	leaq	.LC0(%rip), %rdi	#,
	call	puts@PLT	#
# helloC.c:17:    return 0;
	movl	$0, %eax	#, _3
# helloC.c:18: }
	popq	%rbp	#
	.cfi_def_cfa 7, 8
